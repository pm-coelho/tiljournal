...
class PublicUserAPITests(TestCase):
    """Test public endpoints of the user API"""

    def setUp(self):
        self.client = APIClient()

    def test_user_create_valid_user_success(self):
...
class PrivateUserAPITest(TestCase):
    """Test endpoints of the user API that require authentication"""

    def setUp(self):
        self.user = create_user(
            email='test@test.com', password='testpass123', name='name'
        )
        self.client = APIClient()
